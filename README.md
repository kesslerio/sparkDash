...
- **Forensic LLM telemetry** — restart-safe 10-second availability, queue, KV, latency, cache, speculation, and throughput samples retained for seven days in `config/llm-telemetry.json`
